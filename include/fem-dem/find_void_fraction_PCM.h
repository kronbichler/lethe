...
#ifndef find_void_fraction_pcm_h
#  define find_void_fraction_pcm_h

/**
 * Calculation of void fraction using particle's center method (PCM)
 *
 * @note
 *
 * @author Toni Geitani, Shahab Golshan, Polytechnique Montreal 2019-
 */

template <int dim>
class FindVoidFractionPCM : public FindVoidFraction<dim>
{
public:
  FindVoidFractionPCM<dim>();

  /**
   * Carries out the calculation of void fraction using particle's center
   * method (PCM).
   *
...
#endif /* find_void_fraction_pcm_h */
